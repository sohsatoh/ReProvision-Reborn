 ...
 */
#define kIOPMSleepWakeInterest (kIOPMCapabilityCPU | kIOPMCapabilityDisk | kIOPMCapabilityNetwork | kIOPMCapabilityVideo | kIOPMCapabilityAudio)
...
IOReturn IOPMConnectionCreate(
    ...
    IOPMConnection *newConnection) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
...
IOReturn IOPMConnectionSetNotification(
    ...
    void *param,
    IOPMEventHandlerType handler) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
...
IOReturn IOPMConnectionScheduleWithRunLoop(
    ...
    CFStringRef runLoopMode) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
...
IOReturn IOPMConnectionRelease(
    IOPMConnection connection) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
...
IOReturn IOPMConnectionAcknowledgeEvent(
    ...
    IOPMConnectionMessageToken token) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
...
IOReturn IOPMConnectionAcknowledgeEventWithOptions(
    IOPMConnection connect,
    IOPMConnectionMessageToken token,
    CFDictionaryRef options) __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_NA);
